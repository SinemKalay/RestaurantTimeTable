...
class RestaurantService {
   ...
   // TODO: Refactor unit tests
    ...
    private fun checkOtherDaysRestaurantWorking(currentDay: WeekDays,
            mapDayToSortedHoursList: HashMap<WeekDays, List<TypeValueDTO>>): MutableList<String> {
            ...
            when (typeValueDTO.type) {
                ...
                TypeEnum.close.name -> {
                    if (typeValueDTO == mapDayToSortedHoursList[currentDay]!!.first()
                        ...
                        workingTimesList.add(returnInterval(openingTimeSeconds,typeValueDTO.value,
