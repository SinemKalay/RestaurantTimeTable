...
object Constants {
    ...
    internal const val EXP_MSG_RESP_BODY_NOT_FOUND = "Required request body is missing!"
    internal const val REASON_RESP_BODY_NOT_FOUND = "Appropriate response body should be provided"
    ...
    internal const val EXP_MSG_NO_SUCH_TYPE = "No such type found."
    internal const val REASON_NO_SUCH_TYPE = "Type names must be one of the followings:"
