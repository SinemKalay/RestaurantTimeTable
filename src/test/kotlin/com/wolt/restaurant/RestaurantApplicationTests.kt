...
class RestaurantApplicationTests {
    ...
    @Test
    @DisplayName("Should return error about number of opening and closing times not same")
    fun `fail when unclosed day exists`() {
        val exception = UnmatchedOpenCloseTimeException(TestConstants.EXP_MSG_UNMATCHED_OPEN_CLOSE,
